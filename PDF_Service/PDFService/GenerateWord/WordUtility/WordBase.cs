...
namespace Common
{
    ...
    public class WordBase
    {
        ...
        public string tempFile
        {
            get
            {
                string WantedPath = AppDomain.CurrentDomain.BaseDirectory.Substring(0, AppDomain.CurrentDomain.BaseDirectory.LastIndexOf(@"\"));
                string path = WantedPath.Substring(0, WantedPath.LastIndexOf(@"\")) + "\\Common\\PDFService\\GenerateWord\\Temp\\";
                return path;
            }
        }
        /// <summary>
        ...
        /// word文档
        /// </summary>
        protected static word._Document wDoc = null;
        /// <summary>
        /// word进程
        /// </summary>
        protected static word._Application wApp = null;
        /// <summary>
        /// 空值
        /// </summary>

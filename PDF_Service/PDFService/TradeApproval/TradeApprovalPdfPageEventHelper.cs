...
namespace Common
{
    ...
    /// 页眉页脚水印设置
    /// </summary>
    public class TradeApprovalPdfPageEventHelper : PdfPageEventHelper, IPdfPageEvent
    {
        ...
        public override void OnEndPage(PdfWriter writer, Document document)
        {
            ...
            if (PAGE_NUMBER)
            {
                Phrase footer = new Phrase("第" + (writer.PageNumber) + "页,共 页", fontFooter);
            ...
            //Font fontHeader = new Font(JointacPDF.bfChinese, 12, Font.ITALIC);
            //PdfContentByte pch = writer.DirectContent;
            //pch.SetCharacterSpacing(1.3f);

            //pch.SetColorStroke(new BaseColor(252, 230, 202));//线颜色
            //pch.SetColorFill(BaseColor.BLACK);//字体颜色
            ...
            //iTextSharp.text.Image sealImage = iTextSharp.text.Image.GetInstance(seal, BaseColor.WHITE);
            //sealImage.ScalePercent(40);//40%比例缩小
            //sealImage.SetAbsolutePosition(document.Left + 100, 40);

...
namespace Common
{
    public class CInvoicePdfPageEventHelper : PdfPageEventHelper, IPdfPageEvent
    {
        ...
        public override void OnEndPage(PdfWriter writer, Document document)
        {
            ...
            if (PAGE_NUMBER)
            {
                ...
                //页脚显示的位置
                ColumnText.ShowTextAligned(cb, Element.ALIGN_CENTER, footer, document.Right - 80, document.Bottom + 12, 0);
                //模版 显示总共页数
                cb.AddTemplate(tpl, document.Right - 50 + document.LeftMargin, document.Bottom + 12);//调节模版显示的位置
            }
